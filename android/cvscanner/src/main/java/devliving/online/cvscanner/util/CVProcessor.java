...
public class CVProcessor {
     ...
     * @return
     */
    public static Mat fourPointTransform(Mat src, Point[] pts, Context context) {
...
/////////////////////////////////////////////////////////////////////////////////
//        Rect roi = new Rect(new Double(br.x).intValue(), new Double(br.y).intValue(),
//                new Double(maxWidth).intValue(), new Double(maxHeight).intValue());
//        Mat cropped = new Mat(src, roi);
//
//
//        Bitmap croppedBM = Bitmap.createBitmap(cropped.cols(), cropped.rows(), Bitmap.Config.ARGB_8888);
//        Utils.matToBitmap(src, croppedBM);
...
//            croppedBM.compress(Bitmap.CompressFormat.PNG, 100, out); // bmp is your Bitmap instance
